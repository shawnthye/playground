...
dependencies {
    constraints {
        ...
        api("${Libs.AndroidX.Lifecycle.livedataFoundation}:${Versions.LIFECYCLE}")
        api("${Libs.AndroidX.Lifecycle.runtimeFoundation}:${Versions.LIFECYCLE}")
        ...
        api("${Libs.AndroidX.Test.coreBase}:${Versions.ANDROID_TEST_CORE}")
        api("${Libs.AndroidX.Test.core}:${Versions.ANDROID_TEST_CORE}")
        api("${Libs.AndroidX.Test.espresso}:${Versions.ANDROID_TEST_ESPRESSO}")
        api("${Libs.AndroidX.Test.junitBase}:${Versions.ANDROID_TEST_JUNIT}")
        ...
        api("${Libs.AndroidX.archCore}:${Versions.ARCH}")
        ...
        api("${Libs.LeakCanary.leakCanaryAndroid}:${Versions.LEAK_CANARY}")
        ...
        api("${Libs.Test.Hamcrest.core}:${Versions.HAMCREST}")
        api("${Libs.Test.Hamcrest.library}:${Versions.HAMCREST}")
        api("${Libs.Test.Junit.bom}:${Versions.JUPITER}")
        api("${Libs.Test.Junit.junit4}:${Versions.JUNIT4}")
        api("${Libs.Test.mockk}:${Versions.MOCKK}")
        api("${Libs.Test.robolectric}:${Versions.ROBOLECTRIC}")
